...
export default function PostFooter({ commentLength, postId }) {
  return (
    <>
      <div className="w-full h-8 flex items-center px-3 my-3">
        ...
        <div className="w-full flex justify-between">
          ...
          <p className="ml-3 text-gray-500">
            <Link to={`post-details/${postId}`}>{commentLength} comment</Link>
          </p>
        </div>
      </div>

      <div className="grid grid-cols-3 w-full px-5 border-t-1 border-t-divider pt-3 my-3">
